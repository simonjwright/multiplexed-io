...
package STM32_SVD.FSMC is
   ...
   subtype SDCR_NB_Field is STM32_SVD.Bit;
   subtype SDCR_CAS_Field is STM32_SVD.UInt2;
   subtype SDCR_WP_Field is STM32_SVD.Bit;
   subtype SDCR_SDCLK_Field is STM32_SVD.UInt2;
   subtype SDCR_RBURST_Field is STM32_SVD.Bit;
   ...
   --  SDCMR_CTB array
   type SDCMR_CTB_Field_Array is array (1 .. 2) of SDCMR_CTB_Element
