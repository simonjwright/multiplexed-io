...
package STM32_SVD.USB_OTG_FS is
   ...
   subtype DTXFSTS_INEPTFSAV_Field is STM32_SVD.Short;
   ...
   subtype FS_DIEPTXF_INEPTXSA_Field is STM32_SVD.Short;
   subtype FS_DIEPTXF_INEPTXFD_Field is STM32_SVD.Short;
